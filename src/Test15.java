...
public class Test15 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 4; i++) {
            if (!(split1[i].equals("255")||split1[i].equals("0"))){
                System.out.println(1);
                return ;
            }
        }
        if (!((split1[0].equals("255")&&split1[1].equals("255")&&split1[2].equals("255"))
                ||(split1[0].equals("255")&&split1[1].equals("255")&&split1[2].equals("0"))
                ||(split1[0].equals("255")&&split1[1].equals("0")&&split1[2].equals("0"))))
        {
            System.out.println(1);
            return ;
        }
...
//        }
        ...
        Boolean flag2=false;
        for (int i = 0; i < 4; i++) {
            int ip1 = Integer.parseInt(split2[i]);
            int ip2 = Integer.parseInt(split3[i]);
            int x = ip1 & (Integer.parseInt(split1[i]));
            int y = ip2 & (Integer.parseInt(split1[i]));
            if (x==y){
                flag1=true;
            }else {
                flag1=false;
